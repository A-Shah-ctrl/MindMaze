...
# -----------------
import threading
from eeg_processing import run_udp_listener
import time
# ----------------
...
WALL_COLOR = (0, 0, 0)
PATH_COLOR =  (255, 255, 255)#(174, 198, 207)
PLAYER_COLOR = 	(182, 114, 149)
END_COLOR = (112, 152, 116)
CELL_SIZE = 50
WALL_THICKNESS = 2
FPS = 60
...
def draw_maze(maze, player, last):
    ...
    pygame.draw.rect(screen, END_COLOR, (x_offset + last[1] * CELL_SIZE, y_offset + last[0] * CELL_SIZE, CELL_SIZE, CELL_SIZE))
